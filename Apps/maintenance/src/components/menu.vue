            ...
            <div class="row">
                ...
                <div class="col-md-6 accounts-open">
                    <div class="actions-row">
                        <button type="button" v-on:click="showClientModal" class="btn btn-warning pull-right">Nuevo Cliente</button>
                    </div>
                        ...
                        <vue-tabs v-on:tab-change="tabChanged">
                            <v-tab v-for="client in clients" :key="client.id">
                                ...
                                <div class="container-fluid orders-table">
                                    ...
                                    <div v-for="order in client.orders" :key="order.id" class="row orders-table-row">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="container clients-detail-area">
                            <div class="client-row col-12" v-for="client in clients" :key="client.id">
                                {{client.name}}
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-body">
                    <form>
                        <div id="clientsCheckboxed" class="custom-controls-stacked">
                            <b-form-checkbox v-for="client in clients" v-model="billSelected" :key="client.id" name="client-bill-checks" :value="client.id">
                                {{client.name}}
                            </b-form-checkbox>
                        </div>
...
<script>
import menuService from '@/components/shared/menu-grid/menu-grid.service';
import ClientsService from '@/services/clients.service';
import '@/components/shared/inline-edit.component';
...
export default {
    ...
    methods: {
        ...
        showBillModal: function() {
            this.$refs.checkAccountModal.show();
        },
